    ...
    isWorkable = async () =>{
        try {
            ...
            for(let i=0;i<this.strategies.length;i++) {
                ...
                if (this.containsStringInarray(this.skipTendableCheck,currStrat)) continue;
            ...
            this.workable = this.harvestableStrats.length > 0 ||this.tendableStrats.length > 0
