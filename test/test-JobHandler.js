...
const registerAvailableJobsStub = sinon
  .stub(JobHandler.prototype, "registerAvailableJobs")
  .callsFake(() => {});
const jobExecutorStartStub = sinon
  .stub(JobExecutor.prototype, "start")
  .callsFake(() => {});
const jobExecutorStopStub = sinon
  .stub(JobExecutor.prototype, "stop")
  .callsFake(() => {});
